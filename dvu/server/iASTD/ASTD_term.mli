...
val term_of_variable_name : ASTD_variable.name -> t
val term_of_variable : ASTD_variable.t -> t
val variable_name_of_term : t -> ASTD_variable.name
val parameters_of_variable_names : ASTD_variable.name list -> params
val parameters_of_variables : ASTD_variable.t list -> params
val const_of : ASTD_constant.t -> t
...
val is_variable_name_in_params : ASTD_variable.name -> params -> bool
