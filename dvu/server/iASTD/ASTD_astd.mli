...
type t = Automata of astd_name * ASTD_attribute.t list * ASTD_action.t option * t list * ASTD_arrow.t list * astd_name list* astd_name list  * astd_name
...
(**The parallel composition structure, represented by the name of the astd and the two sub astd of the structure*)
...
(**The quantified parallel composition structure, represented by the name of the astd, the quantified variable, her domain of value and the sub astd*)

    | Guard of astd_name * ASTD_attribute.t list * ASTD_action.t option * ASTD_guard.t list * t
(**The guard structure, represented by the name of the astd, a list of guards and the sub astd *)
...
val automata_of : astd_name -> ASTD_attribute.t list -> ASTD_action.t option -> t list -> ASTD_arrow.t list -> astd_name list-> astd_name list-> astd_name -> t
val sequence_of : astd_name -> ASTD_attribute.t list -> ASTD_action.t option -> t -> t -> t
val choice_of : astd_name -> ASTD_attribute.t list -> ASTD_action.t option -> t -> t -> t
val kleene_of : astd_name -> ASTD_attribute.t list -> ASTD_action.t option -> t -> t
val synchronisation_of : astd_name -> ASTD_label.t list -> ASTD_attribute.t list -> ASTD_action.t option -> t -> t -> t
val parallelcomposition_of : astd_name -> ASTD_attribute.t list -> ASTD_action.t option -> t -> t -> t
val qchoice_of : astd_name -> ASTD_variable.t -> ASTD_constant.domain -> ASTD_attribute.t list -> ASTD_action.t option -> ASTD_optimisation.dependency list -> t -> t
val qsynchronisation_of : astd_name -> ASTD_variable.t -> ASTD_constant.domain -> ASTD_label.t list -> ASTD_attribute.t list -> ASTD_action.t option -> ASTD_optimisation.optimisation list-> t -> t
val qparallelcomposition_of : astd_name -> ASTD_variable.t -> ASTD_constant.domain -> ASTD_attribute.t list -> ASTD_action.t option -> ASTD_optimisation.optimisation list-> t -> t
val guard_of : astd_name -> ASTD_attribute.t list -> ASTD_action.t option -> ASTD_guard.t list -> t -> t
val call_of : astd_name -> astd_name -> ((ASTD_variable.name *ASTD_term.t) list )-> t
...
val get_qastd : t -> t
val get_guard_pred : t -> ASTD_guard.t list
val get_guard_astd : t -> t
val get_called_name : t -> astd_name
val get_called_values : t ->((ASTD_variable.name *ASTD_term.t) list )
val get_optional_code : t -> ASTD_action.t option




val get_data_automata :t -> (astd_name * ASTD_attribute.t list * ASTD_action.t option * t list * ASTD_arrow.t list * astd_name list* astd_name list * astd_name)
val get_data_sequence :t -> (astd_name * ASTD_attribute.t list * ASTD_action.t option * t * t )
val get_data_choice :t -> (astd_name * ASTD_attribute.t list * ASTD_action.t option * t * t )
val get_data_kleene :t -> (astd_name * ASTD_attribute.t list * ASTD_action.t option * t )
val get_data_synchronisation :t -> (astd_name * ASTD_label.t list * ASTD_attribute.t list * ASTD_action.t option * t *t)
val get_data_guard :t -> (astd_name * ASTD_attribute.t list * ASTD_action.t option * ASTD_guard.t list * t)
val get_data_qchoice :t -> (astd_name * ASTD_variable.t * ASTD_constant.domain * ASTD_attribute.t list * ASTD_action.t option * ASTD_optimisation.dependency list *t)
val get_data_qsynchronisation :
               t -> (astd_name * ASTD_variable.t * ASTD_constant.domain * ASTD_label.t list * ASTD_attribute.t list * ASTD_action.t option * ASTD_optimisation.optimisation list * t )
val get_data_call : t -> (astd_name * astd_name * ((ASTD_variable.name *ASTD_term.t) list ))


(**Finds all transitions accessible from the sub_astd *)
val get_sub_transitions : t -> ASTD_transition.t list
...
val get_action : int -> (module  ASTD_plugin_interfaces.Action_interface) option

val register_guard : int -> (module ASTD_plugin_interfaces.Guard_interface) -> unit
val get_guard : int -> (module  ASTD_plugin_interfaces.Guard_interface) option
val get_guard_modules : ASTD_guard.t list -> (module ASTD_plugin_interfaces.Guard_interface) list

(** {3 Printer} *)

val print : t->string-> unit

val apply_post_processing_on_loaded_astd : t -> string -> t