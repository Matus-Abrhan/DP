...
(**The {!ASTD_event.t} type represents the action introduced by the user of the application. 
It means he should introduce a label, the name of the function and a list of constants which are the values of the parameters*)
...
val set_label : ASTD_label.t -> t -> t
val set_consts : ASTD_constant.t list -> t -> t
