(portscan_seq,
	...
	((local,n0,n1),e(_,_,ipdst,portdst,?tcpflags1 : string,_), {file : "guard1"},"",false),
        ((local,n1,n2),e(ipdst,portdst,_,_,?tcpflags2 : string,_), {file : "guard2"},"Functions.action1(count, thres, recon_end)",false)
      };
      {n0,n1,n2};
      {};
      n0
...
(exploit_seq,
	...
	(n5->elem),
      ...
      {
	((local,n4,n5),e(ipsrc,_,ipdst,_,?tcpflags1 : string,_), {file : "guard4"},"",false),
        ((local,n5,n6),e(ipdst,_,ipsrc,_,?tcpflags2 : string,?payload : string), {file : "guard5"},"Functions.action2()",true)
      };
      {n6};
      {};
      n4
